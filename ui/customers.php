            ...
            <div class="">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <a class="btn btn-success btn-md" href="customer-add.php"><i class="fa fa-plus-circle"></i> Add</a>
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>All <small>Customers</small></h2>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                    ...
                                    <table id="datatable-responsive" class="table table-bordered">
                                        ...
                                        <?php foreach ($customer->allCustomers() as $row){ ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="customer-view.php?id=<?= $row['id'] ?>" class="btn btn-info btn-xs edit">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                    <button type="button" id="<?= $row['id'] ?>" class="btn btn-danger btn-xs delete_customer"><i class="fa fa-trash-o"></i></button>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                        </tbody>
...
<script>
   $('.delete_customer').click(function () {
       ...
       Swal.fire({
           ...
           if (result.value) {
               var url = "ajax.php?ajax=dc&id="+id;
               $.ajax({
                   url:url,
                   type:'GET',
                   contentType:false,
