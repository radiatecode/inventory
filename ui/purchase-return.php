            ...
            <div class="">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Purchased Return Order <small>List</small></h2>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                ...
                                <div class="table-responsive">
                                    <table id="datatable-responsive" class="table table-bordered">
                                        ...
                                        <tbody>
                                        <?php foreach ($purchaseReturn->allPurchaseReturn() as $row){
                                            $total_amount = $row['sub_total']-(($row['sub_total']*$row['discount_given'])/100);
    ...
    $('#delete_selected_item').click(function () {
        ...
        if (selected_ids.length>0) {
            Swal.fire({
                ...
                if (result.value) {
                    var url = "ajax.php?ajax=d_selected_purchase_return";
                    $.ajax({
                        url: url,
                        type: 'POST',
                        data: {
