                                    ...
                                    <div class="row">
                                         ...
                                         <div class="col-md-4 col-lg-6 col-xs-12">
                                             ...
                                             <div class="form-group">
                                                 ...
                                                 <div class="">
                                                     <input type="text" id="delivery_date" name="delivery_date" class="form-control col-md-7 col-xs-12" required>
                                                 </div>
                                             </div>
                                             <div class="form-group">
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                       <tr ng-repeat="item in items" ng-model="newItemName" >
                                                           ...
                                                           <td>
                                                               <input type="number" name="total[]" class="form-control col-md-7 col-xs-12" ng-model="item.total" step=".01" min="0" required readonly>
                                                           </td>
                                                           <td>
                                        ...
                                        <div class="col-md-4 col-lg-4 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="">
                                                    <input type="number" id="vat_amount" ng-model="vat_amount" name="vat_amount" class="form-control col-md-7 col-xs-12" step=".01" min="0" required readonly>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="">
                                                    <input type="number" id="due" name="due" ng-model="due" class="form-control col-md-7 col-xs-12" step=".01" min="0" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    app.controller("ItemsController",function($scope,$http) {
        ...
        $scope.selectChange = function (i) {
            ...
            i.unit_price = parseFloat(obj.mrp);
        };
