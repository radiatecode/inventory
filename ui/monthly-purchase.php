...
if (isset($_POST['search'])){
    $data_result = $report->purchase_search($_POST);
            ...
            <div class="">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Monthly Products <small> Purchase</small></h2>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                <form class="form-horizontal" action="monthly-purchase.php" method="post">
                                    <div class="col-md-3">
                                ...
                                <div class="table-responsive">
                                    <table id="monthly_report" class="table table-bordered">
                                        ...
                                        <tbody>
                                         ...
                                         <?php $sl++;
                                         $total_purchase += $item['purchase_qty'];
                                             }
                                         }
                                         ?>
                                        </tbody>
